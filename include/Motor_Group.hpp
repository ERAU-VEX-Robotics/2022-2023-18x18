...
class Motor_Group {
  ...
  public:
     ...
     */
    std::vector<bool> are_stopped(void);
     ...
     */
    std::vector<bool> are_over_current(void);
     ...
     */
    std::vector<bool> are_over_temp(void);
     ...
     */
    std::vector<bool> are_reversed(void);
     ...
     */
    std::vector<int> get_current_limits(void);
     ...
     */
    std::vector<int> get_current_draws(void);
     ...
     */
    std::vector<int> get_efficiencies(void);
     ...
     */
    std::vector<uint32_t> get_faults(void);
     ...
     * @returns A vector containing each motor's fault bitfields
     */
    std::vector<uint32_t> get_flags(void);
     ...
     */
    std::vector<pros::motor_gearset_e_t> get_gearing(void);
     ...
     */
    std::vector<double> get_power(void);
     ...
     */
    std::vector<int> get_target_velocities(void);
     ...
     */
    std::vector<double> get_velocities(void);
     ...
     */
    std::vector<double> get_temperatures(void);
     ...
     * Meters
     */
    std::vector<double> get_torques(void);
     ...
     * milliVolts
     */
    std::vector<int> get_voltages(void);
     ...
     */
    std::vector<int> get_voltage_limits(void);
     ...
     */
    std::vector<bool> get_zero_position_flags(void);
     ...
     *
     * @param encoder_units The new encoder units for the motors - of type
     * pros::motor_encoder_units_e_t
     */
